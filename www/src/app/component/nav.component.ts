...
@Component({
    ...
    template: `
        ...
        <li [routerLinkActive]="['active']" [hidden]="!session.isLoggedIn"><a routerLink="/profile">Profile<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-user"></span></a></li>
        ...
        <li [routerLinkActive]="['active']" [hidden]="!session.isLoggedIn || !session.user.roleAdmin"><a routerLink="/admin/users">Persons<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-user"></span></a></li>
