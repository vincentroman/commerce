...
@Component({
    ...
    template: `
        <li [routerLinkActive]="['active']" [hidden]="!session.isLoggedIn"><a routerLink="/">Home<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
