...
import { LicenseKeyEncoder } from "../src/util/LicenseKeyEncoder";

const expect = chai.expect;

describe("LicenseKeyEncoder", () => {
    describe("toString()", () => {
    ...
    describe("factory()", () => {
        it("Should successfully initialize for a valid provided license key", () => {
            ...
            expect(key.type).to.equal(LicenseKeyEncoder.TYPE_LIMITED);
    ...
    describe("getSignature()", () => {
        it("Should generate a valid signature", () => {
            ...
            let signature = LicenseKeyEncoder.getSignature(s, privateKey);
            expect(signature).to.be.not.empty;
            let result = LicenseKeyEncoder.isSignatureValid(s, signature, publicKey);
